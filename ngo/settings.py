...
SECRET_KEY = '6j57^@wfl42&4ka%=2m1^c$eyfqrqh0o44ejlfzbt8(s2wev0e'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR), r'donations\templates\donations',
                 os.path.join(BASE_DIR), r'donations\templates\registration'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# See django-mongodb-engine docs for OPTIONS settings.
